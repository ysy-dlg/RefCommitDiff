    ...
    for repo_name in os.listdir(input_dir):
        ...
        if os.path.isdir(repo_path):
            ...
            with open(csv_filename, 'w', newline='', encoding='utf-8') as csvfile:
                ...
                writer.writerow(['commit_id', 'commit_date', 'file_name_mjava', 'file_path', 'repository_name', 'hunk_id', 'hunk_header', 'line_id', 'line_content', 'change_type'])  # Added change_type column
...
def write_hunk(writer, commit_id, commit_date, file_name_mjava, file_path, repository_name, hunk_id, hunk_header, hunk_lines):
    ...
    for line_content in hunk_lines:
        ...
        # Write valid code line
        writer.writerow([commit_id, commit_date, file_name_mjava, file_path, repository_name, hunk_id, hunk_header, line_id, line_content, change_type])
        line_id += 1
