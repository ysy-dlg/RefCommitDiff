...
|----------------------------------------|------------------------|---------------------------------|----------------------------------|
| **Subscription Test**                  | ✅                     | ❌                              | ✅ (Inherited subscription test) |
| **Synchronous Message Publication**    | ✅                     | ✅ (Migrated)                  | ❌                              |
| **Asynchronous Message Publication**   | ✅                     | ✅ (Migrated)                  | ❌                              |
| **Mixed Concurrent Message Publication** | ✅                   | ✅ (Migrated)                  | ❌                              |
